      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group row">
              <label for="nama_produk" class="col-md-3 col-md-offset-1 control-label">Nama:</label>
              <div class="col-md-6">
            ...
            <div class="form-group row">
              <label for="merk" class="col-md-3 col-md-offset-1 control-label">Merk:</label>
              <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                  <input type="number" name="harga_beli" id="harga_beli" class="form-control" required autocomplete="off">
                  <span class="help-block with-errors"></span>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="diskon" class="col-md-3 col-md-offset-1 control-label">Masukan Diskon:</label>
              <div class="col-md-6">
                  <input type="number" name="diskon" id="diskon" class="form-control" value="0" autocomplete="off">
                  <span class="help-block with-errors"></span>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-6">
                  <input type="number" name="stok" id="stok" class="form-control" value="0" autocomplete="off">
                  <span class="help-block with-errors"></span>
              </div>
            </div>
          </div>
