                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button onclick="tampilkanProduk()" class="btn btn-info btn-flat" type="button">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="kode_member" value="{{ $memberSelected->kode_member }}" autocomplete="off">
                                            <span class="input-group-btn">
                                                <button onclick="tampilkanMember()" class="btn btn-info btn-flat" type="button">
                                                    <i class="fa fa-arrow-right"></i>
                                                </button>
                                            </span>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="diterima" class="form-control" name="diterima" value="{{ $penjualan->diterima ?? 0 }}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    function tambahProduk() {
        $.post('{{ route('transaksi.store') }}', $('.form-produk').serialize())
            ...
            .fail((errors) => {
                toastr.error('Gagal menambah prduk!')
                    return;
                });
    }
        ...
        $.get(`{{ url('/transaksi/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
                ...
                if ($('#diterima').val() != 0) {
                    ...
                    $('.tampil-terbilang').text('Terbilang: '+ response.kembali_terbilang);
                }
            })
            .fail(errors => {
