...
<body>
    ...
    <table class="data" width="100%">
        ...
        <tfoot>
            <tr>
                <td class="text-right" colspan="6"><b>Total Harga</b></td>
            ...
            <tr>
                <td class="text-right" colspan="6"><b>Total Bayar</b></td>
                <td class="text-right"><b>{{ 'Rp. '. format_uang($penjualan->bayar) }}</b></td>
            </tr>
            <tr>
                <td class="text-right" colspan="6"><b>Diterima</b></td>
                <td class="text-right"><b>{{ 'Rp. '. format_uang($penjualan->diterima) }}</b></td>
            </tr>
            <tr>
                <td class="text-right" colspan="6"><b>Kembali</b></td>
    ...
    <table width="100%">
        <tr>
            <td style="padding-bottom:150px;"><b>Terima Kasih Telah Berbelanja dan Sampai Jumpa</b></td>
